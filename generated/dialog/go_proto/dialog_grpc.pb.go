...
func (c *dialogServiceClient) Send(ctx context.Context, in *SendRequest, opts ...grpc.CallOption) (*SendReply, error) {
	out := new(SendReply)
	err := c.cc.Invoke(ctx, "/dialog.DialogService/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dialogServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListReply, error) {
	out := new(ListReply)
	err := c.cc.Invoke(ctx, "/dialog.DialogService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDialogServiceServer) Send(context.Context, *SendRequest) (*SendReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Send not implemented")
}
func (UnimplementedDialogServiceServer) List(context.Context, *ListRequest) (*ListReply, error) {
...
func _DialogService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dialog.DialogService/Send",
	}
...
func _DialogService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dialog.DialogService/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var DialogService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/dialog/dialog.proto",
}
