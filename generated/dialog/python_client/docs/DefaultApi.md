...
------------- | ------------- | -------------
[**dialog_message_message_id_read_put**](DefaultApi.md#dialog_message_message_id_read_put) | **PUT** /dialog/message/{message_id}/read | 
...
# **dialog_message_message_id_read_put**
> dialog_message_message_id_read_put(message_id)
...
> DialogUserIdSendPost200Response dialog_user_id_send_post(user_id)
...
[**DialogUserIdSendPost200Response**](DialogUserIdSendPost200Response.md)
